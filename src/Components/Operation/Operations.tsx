    ...
    <div className="flex-column p-4 mt-16 bg-sky-50 rounded-sm m-4">
      <div className="dropdown-container flex h-16 p-4 rounded-md">
        ...
        <div className="ml-8">
          <Select
            styles={dropDownStyles}
            options={devicesInfo.length ? devicesInfo.map((device: any) => ({
       ...
       */}
        ...
        {isDeviceInProcess ? (
          <button
            type="submit"
            className="start px-4 py-2 rounded-lg bg-sky-200 text-white font-semibold"
          >
            Start
          </button>
        ) : (
          <button
            type="submit"
            onClick={handleStartPrntClick}
            className="start px-4 py-2 rounded-lg bg-sky-600 text-white font-semibold"
          >
            Start
          </button>
        )}
        ...
        {isDeviceInProcess && !isDeviceIdle ? (
          <button
            ...
            className="ml-8 pause px-4 py-2 rounded-lg bg-sky-600 text-white font-semibold"
            type="submit"
          >
            PauseOrResume
          </button>
          ...
          <button
            className="ml-8 pause px-4 py-2 rounded-lg bg-sky-200 text-white font-semibold"
            type="submit"
          >
            PauseOrResume
          </button>
        ...
        {isDeviceInProcess && !isDeviceIdle ? (
          <button
            ...
            className="ml-8 cancel px-4 py-2 rounded-lg bg-sky-600 text-white font-semibold"
            type="submit"
          >
            Cancel
          </button>
          ...
          <button
            className="ml-8 cancel px-4 py-2 rounded-lg bg-sky-200 text-white font-semibold"
            type="submit"
          >
            Cancel
          </button>
      ...
      <div className="logs-container flex h-80 p-4 rounded-md"></div>
    </div>
  );
}
